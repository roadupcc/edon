...
pub fn init<'s>(scope: &mut v8::HandleScope<'s>) -> v8::Local<'s, v8::Object> {
    ...
    JTsRuntime::set_func(scope, obj, "read", read);
    JTsRuntime::set_func(scope, obj, "readSync", read_sync);
    JTsRuntime::set_func(scope, obj, "readPromise", read_promise);
    return obj;
}
